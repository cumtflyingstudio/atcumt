...
<template>
  ...
  <a-modal
    v-model:open="open" title="用户登录" :confirm-loading="confirmLoading" width="350px" class="loginBox"
  ...
  >
    <a-space direction="vertical" class="login">
      ...
      <a-input v-if="page == 1" v-model:value="email" placeholder="验证码" />
      <a-input v-if="page == 1" v-model:value="password" placeholder="密码" />
      <a-input v-if="page == 2" v-model:value="email" placeholder="邮箱" />
      <a-input v-if="page == 2" v-model:value="email" placeholder="验证码" />
